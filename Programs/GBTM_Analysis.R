...
#Run K-group latent class trajectory model (k=2~7): parallel gridsearch 
  ...
  Time_rep50maxit30=rbind(time_k2,
                          time_k3,
                          time_k4,
                          time_k5,
                          time_k6,
